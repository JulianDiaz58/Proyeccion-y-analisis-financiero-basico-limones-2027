...
Script encargado de simular el histórico agronómico, climático, de insumos y de mercado para el sector citrícola entre 2010 y 2026 (865 semanas simuladas en 40 lotes, generando 34.600 registros operativos).

🛠️ Tecnologías Utilizadas
Pandas & NumPy: Estructuración de DataFrames, transformaciones y distribuciones estadísticas.
Faker (es_AR): Inicialización de semillas y datos contextuales.
...
Estacionalidad de Precipitaciones:Verano/Primavera: Distribución Gamma (shape=3, scale=12). Transición (Otoño): Distribución Gamma (shape=1.5, scale=8).Invierno: Distribución Gamma (shape=0.5, scale=4).
Riesgo de Heladas: Detección de temperaturas < 5 gradosC durante junio, julio y agosto.
...
Demanda de Fungicida: Aplicación condicionada por umbral de precipitaciones ($> 35\text{ mm}$) entre Septiembre y Diciembre.
